    ...
    return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!uiAddress) {
                    ...
                    if (!process.env.MO_DEV_HIDE_URLS) {
                        ...
                        canisters.forEach((canister) => {
                            ...
                            if (id) {
                                log(0, picocolors_1.default.cyan(`${picocolors_1.default.bold(`${canister.alias}`)} → ${picocolors_1.default.white(`http://127.0.0.1:4943?canisterId=${uiAddress}&id=${id}`)}`));
                            }
                        });
                    }
                }
        ...
        const updateCanister = (canister, { quiet = false } = {}) => {
            try {
                ...
                console.error(picocolors_1.default.red(`Error while updating canister '${canister.alias}':\n${err.message || err}`));
                return false;
            }
        };
        ...
        const removeCanister = (canister, { quiet = false } = {}) => {
            try {
                ...
                console.error(picocolors_1.default.red(`Error while removing canister '${canister.alias}':\n${err.message || err}`));
            }
        };
